...
Multi-language OCR, whole-project archive verification, collection graph composition, authenticated desktop worker dispatch, and versioned backup policies. Each needs its own design and tests.
